...
from models.MESM.utils import split_and_pad, split_expand_and_pad
from models.MESM.utils import sample_outclass_neg, sample_inclass_neg, inverse_sigmoid
from models.MESM.model.transformer import T2V_TransformerEncoderLayer, T2V_TransformerEncoder
from models.MESM.model.text_encoder import CLIPTextEncoder, GloveTextEncoder, GLT
...
class MESM(nn.Module):
    ...
    def __init__(
        self, text_encoder, glt, spatial_attention, enhance_encoder, t2v_encoder, 
        transformer, vid_position_embed, txt_position_embed, txt_dim, 
        vid_dim, num_queries, input_dropout, 
        ...
        self.glt = glt                              # Grounded Latent Tree
        self.spatial_attention = spatial_attention  # Frame-level spatial attention
    ...
    def forward(self, video_feat, video_mask, words_id, words_mask, words_weight, num_clips, **kwargs):
        ...
        if isinstance(self.glt, GLT):
            sentence_feat = self.glt(words_feat)

        video_feat = self.spatial_attention(video_feat, sentence_feat)
