...
from models.MESM.runner import build_vocab, build_vocab_from_pkl
from models.MESM.runner import build_dataloader, build_model
from models.MESM.runner import build_criterion
from models.MESM.utils import TestOptions, AverageMeter
from models.MESM.utils import PostProcessorDETR
from models.MESM.utils import count_parameters, merge_state_dict_with_module
from models.MESM.utils import span_cxw_to_xx 
from models.MESM.utils import save_json, save_jsonl
from models.MESM.utils import compute_temporal_iou_batch_cross
from models.MESM.utils import interpolated_precision_recall, compute_temporal_iou_batch_paired
from models.MESM.utils import get_window_len, temporal_nms
from models.MESM.dataset import prepare_batch_input, CharadesDataset
...
def inference():
    ...
    test_dataset = CharadesDataset(
                **dataset_config, recfw=False, split="test"
                )
