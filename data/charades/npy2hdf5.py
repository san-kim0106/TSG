...
if __name__ == '__main__':
    ...
    # feat_path = '/home/kimsan/models/MESM/data/charades/charades/rgb_features/*'
    # h5_file = '/home/kimsan/models/MESM/data/charades/vgg_UMT.hdf5'
    # npy2hdf5(feat_path, h5_file)
    
    feat_path = '/home/kimsan/TSG/data/charades/features/i3d_spatial_2fps/*'
    h5_file = '/home/kimsan/TSG/data/charades/i3d_spatial_2fps.hdf5'
    npy2hdf5(feat_path, h5_file)
